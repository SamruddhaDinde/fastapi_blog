...
def verify_access_token(token: str)-> str | None:
    #verify the JWT access token and return the subject (user id) if valid"
    try:
        payload = jwt.decode(
            token,
            settings.secret_key.get_secret_value(),
        ...
        # we will store the user id in the sub field aand then this will work
...
CurrentUser = Annotated[models.User, Depends(get_current_user)] # we use an alias currentuser
